...
/**
 * Exportador Excel para la aplicación.
 *
 ...
 *   $binario = $exp->generate();
 *
 * ESTILOS DISPONIBLES (constantes en las clases XlsxWriter/CsvWriter):
...
class ExcelExporter
{
    ...
    public const STYLE_INFO        = 2;
    public const STYLE_OK          = 3;
    public const STYLE_FALTA       = 4;
    public const STYLE_FUTURO      = 5;
    public const STYLE_TOTALES     = 6;
    public const STYLE_DATE_HEADER = 7;
